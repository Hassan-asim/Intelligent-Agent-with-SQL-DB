...
- **Graphical data representation** for query results
...
└── 📂 SQLAgent/                        # SQL Agent Educational Package
    ...
    └── 📂 scripts/                      # Progressive tutorial scripts
        ...
        └── 🛠️ setup_database.py         # Script to create and populate the database with demo data
```
...
The included SQLite database contains realistic e-commerce data and new educational data:
...
**"Gemini API key not found" or Quota Exceeded**
```bash
# Verify .env file configuration
cp .env.example .env
# Edit .env and add: GEMINI_API_KEY=AIzaSy...
# Check your Google Cloud project for API quotas and billing details.
```
